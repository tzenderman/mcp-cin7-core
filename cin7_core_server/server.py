...
def create_mcp_server(auth=None):
    ...
    mcp.resource("cin7://templates/customer")(templates.resource_customer_template)
    mcp.resource("cin7://templates/customer/{customer_id}")(templates.resource_customer_by_id)
    mcp.resource("cin7://templates/customer/name/{name}")(templates.resource_customer_by_name)
